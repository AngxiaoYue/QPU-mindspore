...
class GetDatasetGenerator:
    ...
    Arguments:
        data_path: the path to '.npy' data, the shape of data should be (N, C, T, V, M) (num_samples, 4, num_frame, num_joint, max_body)
    ...
    def load_data(self, mmap):
        ...
        with open(self.label_path, 'rb') as f:
            ...
            self.label = np.array(self.label).astype(np.int32)
        # load data
        if mmap:
